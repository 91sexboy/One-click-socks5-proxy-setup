...
```text
9ced8c24843084dcf5db4561b34d7ab34222e45cb3ff900ba70b7ee0d49d699b  socks5.sh
```
...
printf '%s  %s\n' '9ced8c24843084dcf5db4561b34d7ab34222e45cb3ff900ba70b7ee0d49d699b' socks5.sh | sha256sum -c -
sudo sh socks5.sh
```
