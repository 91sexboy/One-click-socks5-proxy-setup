...
```text
d7b7b504eb741c02920b541ea32286ff6b9437574c6f73dac1e7879b42869e59  socks5.sh
```
...
printf '%s  %s\n' 'd7b7b504eb741c02920b541ea32286ff6b9437574c6f73dac1e7879b42869e59' socks5.sh | sha256sum -c -
sudo sh socks5.sh
```
