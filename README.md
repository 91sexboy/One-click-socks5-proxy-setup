...
```text
5e0a5cccc1837e868bd82556c9f49e05375295afc74888915d0e61ca8926f48e  socks5.sh
```
...
printf '%s  %s\n' '5e0a5cccc1837e868bd82556c9f49e05375295afc74888915d0e61ca8926f48e' socks5.sh | sha256sum -c -
sudo sh socks5.sh
```
