...
```text
e60a5e0127c6d3fcc5d02d605d86299af1e5c86fd47df7b2537209385654bf4d  socks5.sh
```
...
printf '%s  %s\n' 'e60a5e0127c6d3fcc5d02d605d86299af1e5c86fd47df7b2537209385654bf4d' socks5.sh | sha256sum -c -
sudo sh socks5.sh
```
